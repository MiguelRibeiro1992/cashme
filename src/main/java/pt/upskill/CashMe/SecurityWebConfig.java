...
public class SecurityWebConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers( "/adminDashboard","/adminDashboard/**","/adminDashboard/categories/save", "/adminDashboard/manageItems", "/manageItems/**", "/adminDashboard/manageStores", "/manageStores/**").hasRole("ADMIN");
