...
public class SecurityWebConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers("/categories", "/categories/**", "/cart", "/cart/**", "/mainPage", "/scan/**", "/storeView", "/storeView/**","/wishlist/**", "/aboutUs", "/contacts", "/messageSubmit", "/storesMap","/account","/item/**", "/", "/underConstruction","/api/","/api/**","/stores", "/availableSoon").hasAnyRole("USER", "ADMIN");
